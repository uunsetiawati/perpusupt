...
<footer class="py-4 bg-grey-darkest text-grey-lighter" style="background-color:#1d63dc;">
    <div class="container">
        <div class="row py-4">
            <div class="col-md-3">
              <?php
              ...
              <?php } ?>
                ...
                <ul class="list-reset">
                    ...
                    <li><a class="text-light" href="index.php?p=login"><?= __('Login'); ?></a></li>
        ...
        <div class="flex font-thin text-sm">
            <p class="flex-1">&copy; <?php echo date('Y'); ?> &mdash; SDC  & TIM IT UPT</p>
