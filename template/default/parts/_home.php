...
<section class="mt-5 container">
    ...
    <ul class="topic d-flex flex-wrap justify-content-center px-0">
        ...
        <!-- 
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="index.php?subject=jurnal&search=search" class="d-flex flex-column">
                <img src="<?=  assets('images/10-journal.png'); ?>" width="80" class="mb-3 mx-auto"/>
                <?=  __('Journal'); ?>
            </a>
        </li>
        -->
...
<section class="mt-5 bg-white">
    <div class="container py-5">
        <h4 class="mb-4">
            <?php echo __('Onesearch.id - UPTKUKM JATIM');?>
            <br>
            <small class="subtitle-section"><?php echo __('Perpustakaan UPTKUKM Jatim Telah Terintegrasi dengan Sistem Pencarian Onesearch Indonesia');?></small>
        </h4>
    </div>
        <!--Widget OAI-->
        ...
        <script>
          (function() {
            ...
            fr.src = "https://onesearch.id/Search/Results?widget=1&library_id="+id;
