...
if (isset($_POST['detail']) OR (isset($_GET['action']) AND $_GET['action'] == 'detail')) {
  ...
  // e-DDC by Team e-DDC
  $str_input = '<div class="'.$visibility.'" ><a class="notAJAX button btn btn-default openPopUp" href="'.MWB.'bibliography/pop_ddc.php?biblioID='.$rec_d['biblio_id'].'" title="'.__('e-DDC for SLiMS &copy 2015 Modif By Adhi SLiMS').'" height="550" width="850">'.__('e-DDC').'</a> Search Classification Number with Quick e-DDC</div>';
  $form->addAnything('e-DDC SLiMS 9', $str_input);
